...
public class FavoritesRepository {
    ...
    public List<RecipeDto> MyFavorites(String id) {
        List<RecipeDto> results =
                query.select(Projections.constructor(RecipeDto.class, favorites.member.id,post.menu,record.totalCarbohydrate,record.totalFat,record.totalFat, record.totalKcal, record.requiredFood, post.recipe))
